  ...
  return (
    <nav style={{
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 72 }}>
        ...
        {/* Hamburger */}
        <button onClick={() => setOpen(!open)} style={{ background: "none", border: "none", color: "var(--amber)", cursor: "pointer", display: "none" }} className="show-mobile">
      ...
      {/* Mobile menu */}
      {open && (
        <div style={{ background: "rgba(26,31,46,0.99)", padding: "16px 24px 24px", borderTop: "1px solid rgba(245,166,35,0.2)" }}>
          {navbar.links.map((l) => (
